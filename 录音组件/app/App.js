...
const filename = '../../../../../sdcard/robot/rndata/system_2d01160272669884793b18983a46dcd0/test.mp4';
const TAG = 'audioToolkit-----:';
...
export default class App extends Component<Props, State> {
  ...
  _reloadPlayer() {
    ...
    this.player = new Player(filename, {
      ...
      if (err) {
        console.log(TAG + 'error at _reloadPlayer():' + JSON.stringify(err));
      } else {
        console.log(TAG + 'else error at _reloadPlayer():' + err);
  ...
  render() {
    return (
      <SafeAreaView style={{backgroundColor: '#FFF', flex: 1, overflow: 'scroll' }}>
        <View>
