...
public class GlobalData {
    private static final String TAG = com.example.myfirstapp.maputils.GlobalData.class.getSimpleName();
    ...
    private static com.example.myfirstapp.maputils.GlobalData mInstance;

    public static com.example.myfirstapp.maputils.GlobalData getInstance() {
        if (null == mInstance) {
            mInstance = new com.example.myfirstapp.maputils.GlobalData();
        }
        return mInstance;
    }
