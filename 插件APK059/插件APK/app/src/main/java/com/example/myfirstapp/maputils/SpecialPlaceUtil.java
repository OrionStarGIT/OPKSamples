...
/*    private SpecialPlaceUtil() {
    ...
    public static com.example.myfirstapp.maputils.SpecialPlaceUtil getInstance() {
        return Singleton.INSTANCE;
    }

    private static class Singleton {
        static com.example.myfirstapp.maputils.SpecialPlaceUtil INSTANCE = new com.example.myfirstapp.maputils.SpecialPlaceUtil();
    }
...
/*    public static boolean isNavigatorPoint(Constant.NavigatorPoint navigatorPoint,
    ...
    public static boolean isNavigatorPoint(Constant.NavigatorPoint navigatorPoint,
                                           String placeName) {
        LogTools.info("   方法内部 POINT1点的位置===：" + navigatorPoint + "   站点名称===：" + placeName);
