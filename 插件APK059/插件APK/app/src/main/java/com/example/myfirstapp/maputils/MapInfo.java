...
public class MapInfo implements Comparable<MapInfo> {
    ...
    @Override
    public int compareTo(@NonNull com.example.myfirstapp.maputils.MapInfo info) {
        return info.getVersion().compareTo(this.getVersion());
    }

    @Override
    public boolean equals(Object obj) {
        if (!(obj instanceof com.example.myfirstapp.maputils.MapInfo)) {
            return false;
        }

        return Objects.equals(((com.example.myfirstapp.maputils.MapInfo) obj).mapName, this.mapName);
    }
