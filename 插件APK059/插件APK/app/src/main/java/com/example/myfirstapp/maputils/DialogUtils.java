...
public class DialogUtils {
    ...
    private static com.example.myfirstapp.maputils.DialogUtils mInstance;

    public static com.example.myfirstapp.maputils.DialogUtils getInstance() {
        if (null == mInstance) {
            mInstance = new com.example.myfirstapp.maputils.DialogUtils();
        }
        return mInstance;
    }
