 ...
 */
@observer
export class AppScreen extends BaseComponent<BaseComponentProps, MainViewModel, MainVoice> {
    ...
    public render() {
        ...
        return (
            <View>
                <Text style={{ fontSize: 17, color: 'red'}}>{JSON.stringify(this.props.navigation)} {mainModel.getInfoText()}</Text>
                <Button title={'Trigger to Demo'} onPress={
                    () => {
