 ...
 * 传入参数
 */
export interface GetNearestPlaceViewProp {
    viewModel?: GetNearestPlaceViewModel;
}
...
@observer
export class GetNearestPlaceView extends Component<GetNearestPlaceViewProp> {
            ...
            <View style={styles.rootView}>
                <View style={styles.button}>
                    <Button
                        color={'dodgerblue'}
                        title={'获取最近位置'}
                        onPress={this.props.viewModel.onPressGetNearestPlace}/>
                </View>
