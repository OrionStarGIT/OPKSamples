 ...
 * 传入参数
 */
export interface BodyFollowViewProp {
    viewModel?: BodyFollowViewModel;
}
...
@observer
export class BodyFollowView extends Component<BodyFollowViewProp> {
            ...
            <View style={styles.rootView}>
                <View style={styles.button}>
                    <Button
                        color={'dodgerblue'}
                        title={'开始人体追踪'}
                        onPress={this.props.viewModel.onPressStartFollow}/>
                </View>
                <View style={styles.button}>
                    <Button
                        color={'dodgerblue'}
                        title={'停止人体追踪'}
                        onPress={this.props.viewModel.onPressStopFollow}/>
                </View>
