 ...
 * 传入参数
 */
export interface StandardFaceTrackViewProp {
    viewModel?: StandardFaceTrackViewModel;
}
...
@observer
export class StandardFaceTrackView extends Component<StandardFaceTrackViewProp> {
