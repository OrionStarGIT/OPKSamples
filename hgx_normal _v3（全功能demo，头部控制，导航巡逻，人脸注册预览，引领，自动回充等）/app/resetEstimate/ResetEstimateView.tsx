 ...
 * 传入参数
 */
export interface ResetEstimateViewProp {
    viewModel?: ResetEstimateViewModel;
}
...
@observer
export class ResetEstimateView extends Component<ResetEstimateViewProp> {
            ...
            <View style={styles.rootView}>
                <View style={styles.button}>
                    <Button
                        color={'dodgerblue'}
                        title={'视觉重定位'}
                        onPress={this.props.viewModel.onPressVisionResetEstimate}/>
                </View>
                <View style={styles.button}>
                    <Button
                        color={'dodgerblue'}
                        title={'充电桩重定位'}
                        onPress={this.props.viewModel.onPressChargingPoleResetEstimate}/>
                </View>
                <View style={styles.button}>
                    <Button
                        color={'dodgerblue'}
