import { BaseComponent, triggerManager, BaseComponentProps, ComponentEvent, ComponentResultConst, ComponentErrorConst, ChargeStartParam, ChargeStartComponent } from 'orionos-eve-core';
 ...
 */
@observer
export class AutoChargeScreen extends BaseComponent<BaseComponentProps, DemoViewModel, DemoVoice> {
