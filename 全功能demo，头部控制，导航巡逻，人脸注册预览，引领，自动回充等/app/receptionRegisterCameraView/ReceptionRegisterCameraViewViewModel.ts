...
import { ReceptionRegisterCameraViewModel } from './ReceptionRegisterCameraViewModel';

export class ReceptionRegisterCameraViewViewModel extends BaseViewModel {

    //数据模块
    private mModel: ReceptionRegisterCameraViewModel;
    ...
    public constructor() {
        super('BasicMotion');
        this.mModel = new ReceptionRegisterCameraViewModel();
    }
    ...
    public onCaptureState = (
        ...
        this.mModel.setSourcImage(originalImageFile);
        this.mModel.setCompressImage(compressedFile);
    };

    public getSourcImage(): string {
        return this.mModel.getSourcImage();
    }
