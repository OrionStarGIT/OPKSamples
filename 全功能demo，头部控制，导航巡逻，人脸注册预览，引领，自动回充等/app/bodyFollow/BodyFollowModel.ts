...
import { BodyFollowParam } from 'orionos-eve-core';

export class BodyFollowModel {
    /**
     * 人体追踪参数
     */
    private readonly mBodyFollowParam: BodyFollowParam;
     ...
     */
    public constructor() {
        this.mBodyFollowParam = new BodyFollowParam();
    }
